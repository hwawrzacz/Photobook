class HTMLExporter {
    ...
    *{box-sizing:border-box;}
    body{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}main#view{display:-webkit-box;display:-ms-flexbox;display:flex;width:100% !important;height:auto !important;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}div.page{position:relative;min-width:595px;min-height:842px;margin:20px;overflow:hidden;display:block !important}div.page:first-child{margin:20px 100%}.image-container{position:absolute;background-position:center;background-size:100% 100%;cursor:default}.textbox-container{position:absolute}.textbox-container input[type=text]{position:relative;top:0;left:0;width:100%;height:100%;padding:10px;font-size:inherit;font-weight:inherit;font-style:inherit;text-decoration:inherit;text-align:inherit;border:none;outline:none}.textbox-tools,.hooks-container{display:none}
